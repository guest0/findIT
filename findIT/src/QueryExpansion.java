...
public class QueryExpansion {
	...
	private HashMap<String, HashMap<String, Double>> badTerms	= new HashMap<String, HashMap<String,Double>>();	//vollst�ndigkeitshalber
	...
	/*private double calcSumQiSIM(String queryId, String goodTerm) {		// term-similarit�ts-gewichte aufsummieren?
